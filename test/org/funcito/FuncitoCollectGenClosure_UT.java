...
public class FuncitoCollectGenClosure_UT {
    ...
    @Test
    public void testClosureFor_ValidateDetectsMismatchedGenericTypes() {
        Closure<Generic<Float>> floatGenericClosure = closureFor(callsTo(Generic.class).incAndGet());
...
//        floatGenericClosure.f(integerGeneric);
    }
    ...
    @Test
    public void testClosureFor_SingleArgBinding() {
        ...
        Closure<IncList> incElem0Func = closureFor(callsToIncList.incIndex(0));
        Closure<IncList> incElem2Func = closureFor(callsToIncList.incIndex(2));
