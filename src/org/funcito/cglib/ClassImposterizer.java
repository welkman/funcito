...
public class ClassImposterizer  {
    ...
    private static final NamingPolicy NAMING_POLICY_THAT_ALLOWS_IMPOSTERISATION_OF_CLASSES_IN_SIGNED_PACKAGES = new FuncitoNamingPolicy() {
        @Override
...
//        enhancer.setCallbackTypes(new Class[]{MethodInterceptor.class, NoOp.class});
        ...
        if (mockedType.getSigners() != null) {
            ...
            enhancer.setNamingPolicy(FuncitoNamingPolicy.INSTANCE);
        }
